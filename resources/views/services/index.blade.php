    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 h-fit">
            ...
            <form action="{{ route('services') }}" method="GET">
                ...
                <a href="{{ route('services') }}" class="block text-center text-sm text-gray-500 mt-2 hover:underline">
                    Clear All
                </a>
            </form>
        </div>
        ...
        <div class="lg:col-span-3">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition">
                    ...
                    <p class="text-gray-600 text-sm mb-2">by {{ $service->vendor->business_name }}</p>
                    @if($service->pricing_type === 'fixed')
                    <p class="text-green-700 font-bold mb-4">Starting from KES {{ number_format($service->price) }}</p>
                    @else
