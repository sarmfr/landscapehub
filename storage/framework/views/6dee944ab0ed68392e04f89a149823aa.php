...
<div class="max-w-3xl mx-auto px-6 py-12">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-green-800 text-white p-8 text-center">
            ...
            <p class="text-green-100">Order #<?php echo e($order->order_number); ?></p>
        </div>
        ...
        <div class="p-8">
            <div class="flex justify-between items-center mb-8 pb-6 border-b">
                <div>
                    ...
                    <p class="text-4xl font-black text-gray-900">KES <?php echo e(number_format($order->total_amount)); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-gray-600 text-sm italic">Paying via Lipa na M-Pesa</p>
                    <p class="font-bold text-green-700"><?php echo e($order->mpesa_phone); ?></p>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('order.payment.process', $order->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landscapehub\resources\views/orders/payment.blade.php ENDPATH**/ ?>