...
<div class="bg-gray-50 min-h-screen py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <a href="<?php echo e(route('quotes.create')); ?>" class="inline-flex items-center bg-green-800 text-white font-black px-8 py-4 rounded-2xl hover:scale-105 hover:bg-green-700 active:scale-95 transition-all shadow-lg whitespace-nowrap">
        ...
        <div class="bg-white rounded-3xl p-12 text-center shadow-md">
            ...
            <a href="<?php echo e(route('quotes.create')); ?>" class="inline-flex items-center text-green-800 font-black hover:underline">
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <h3 class="text-xl font-black text-gray-900 leading-tight truncate max-w-xs">
                                <?php echo e(Str::limit($quote->description, 50)); ?>
                    ...
                    <div class="flex items-center justify-between bg-gray-50 rounded-2xl p-4">
                        <div class="flex items-center">
                            <div class="flex -space-x-2 mr-3">
                                <?php $__currentLoopData = $quote->responses->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-8 h-8 rounded-full border-2 border-white bg-green-100 flex items-center justify-center text-[10px] font-black text-green-800 uppercase">
                                    <?php echo e(substr($resp->vendor->business_name, 0, 1)); ?>

                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <span class="text-sm font-bold text-gray-700">
                                <?php echo e($quote->responses->count()); ?> <?php echo e(Str::plural('Proposal', $quote->responses->count())); ?>

                            </span>
                        </div>
                        <a href="<?php echo e(route('quotes.show', $quote)); ?>" class="text-green-800 font-bold hover:underline">View All</a>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landscapehub\resources\views/quotes/index.blade.php ENDPATH**/ ?>