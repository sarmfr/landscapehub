...
<div class="bg-gray-50 p-8 rounded-3xl min-h-screen">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <a href="<?php echo e(route('vendor.quotes.responses')); ?>" class="inline-flex items-center text-green-800 font-bold hover:underline">
            View My Proposals
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 hover:shadow-xl hover:border-green-300 transition-all">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-48 h-48 rounded-2xl overflow-hidden flex-shrink-0">
                    <img src="<?php echo e(Storage::url($quote->image)); ?>" alt="Project" class="w-full h-full object-cover">
                </div>
                <?php endif; ?>
                <div class="flex-grow">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <span class="text-xs text-gray-400 font-bold">Posted <?php echo e($quote->created_at->diffForHumans()); ?></span>
                    </div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6"><?php echo e(Str::limit($quote->description, 300)); ?></p>

                    <div class="flex items-center justify-between gap-4 pt-6 border-t border-gray-50">
                        <div class="text-sm text-gray-500 font-bold">
                            <span class="text-gray-900"><?php echo e($quote->responses->count()); ?></span> proposals received so far
                        </div>
                        <a href="<?php echo e(route('vendor.quotes.show', $quote)); ?>" class="bg-green-800 text-white font-black px-8 py-3 rounded-2xl hover:scale-105 hover:bg-green-700 active:scale-95 transition-all shadow-lg whitespace-nowrap">
                            Review & Propose
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landscapehub\resources\views/vendor/quotes/index.blade.php ENDPATH**/ ?>