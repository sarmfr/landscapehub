...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-8">
        <form action="<?php echo e(route('vendor.services.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="6"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
                    placeholder="Describe your service in detail (at least 20 characters)..."><?php echo e(old('description')); ?></textarea>
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="pricing_type" value="fixed" <?php echo e(old('pricing_type', 'fixed') === 'fixed' ? 'checked' : ''); ?> onchange="togglePriceField()" class="w-4 h-4 text-green-600">
                        <span class="font-medium">Fixed Price</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="pricing_type" value="quote" <?php echo e(old('pricing_type') === 'quote' ? 'checked' : ''); ?> onchange="togglePriceField()" class="w-4 h-4 text-green-600">
                        <span class="font-medium">Quote-Based</span>
                    </label>
                </div>
            </div>
            <div id="price-field" class="mb-6 <?php echo e(old('pricing_type') === 'quote' ? 'hidden' : ''); ?>">
                <label for="price" class="block text-sm font-semibold text-gray-700 mb-2">Price (KES) <span class="text-red-500">*</span></label>
                <input type="number" id="price" name="price" value="<?php echo e(old('price')); ?>" step="0.01" min="0"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-8">
                ...
                <select id="status" name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600">
                    <option value="active" <?php echo e(old('status', 'active') === 'active' ? 'selected' : ''); ?>>Active (visible to customers)</option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landscapehub\resources\views/vendor/services/create.blade.php ENDPATH**/ ?>