...
<div class="max-w-5xl mx-auto px-6 py-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <a href="<?php echo e(route('bookings.my')); ?>" class="text-green-700 hover:underline font-bold">← My Bookings</a>
            <h1 class="text-3xl font-black mt-2 text-gray-900">Booking Request Details</h1>
            <p class="text-gray-500">Submitted on <?php echo e($booking->created_at->format('M d, Y \a\t H:i')); ?></p>
        </div>
                ...
                <div class="p-8">
                    <div class="flex items-start gap-6">
                        <div class="w-32 h-32 rounded-2xl bg-gray-100 overflow-hidden flex-shrink-0">
                            <?php if($booking->service->getImageUrl()): ?>
                            <img src="<?php echo e($booking->service->getImageUrl()); ?>" alt="<?php echo e($booking->service->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center text-4xl">🏗</div>
                            <?php endif; ?>
                        </div>
                        <div>
                            <h3 class="text-2xl font-black text-gray-900 mb-1"><?php echo e($booking->service->name); ?></h3>
                            <p class="text-gray-600 mb-4">Provided by <span class="font-bold text-green-700"><?php echo e($booking->vendor->business_name); ?></span></p>
                            <div class="flex items-center gap-4">
                                <?php if($booking->service->pricing_type === 'fixed'): ?>
                                <p class="text-green-800 font-black text-2xl">KES <?php echo e(number_format($booking->service->price)); ?></p>
                                <?php else: ?>
                                ...
                                <a href="<?php echo e(route('reviews.service', $booking->service_id)); ?>" class="bg-yellow-400 text-yellow-900 px-4 py-1 rounded-full text-xs font-black hover:bg-yellow-500 transition shadow-sm uppercase tracking-widest">Rate Service</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900"><?php echo e(\Carbon\Carbon::parse($booking->booking_date)->format('l, M d, Y')); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-400 uppercase font-black tracking-widest mb-1">Project Location</p>
                            <p class="text-lg font-bold text-gray-900"><?php echo e($booking->location); ?></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border italic text-gray-700 leading-relaxed">
                            <?php echo e($booking->description); ?>
                    ...
                    <div>
                        ...
                        <div class="rounded-2xl overflow-hidden border max-w-md">
                            <img src="<?php echo e(asset('storage/' . $booking->image)); ?>" alt="Reference Photo" class="w-full h-auto">
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-bold"><?php echo e($booking->vendor->business_phone ?? 'Available upon confirmation'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">🏫</div>
                        <div>
                            ...
                            <p class="font-bold"><?php echo e($booking->vendor->business_name); ?></p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landscapehub\resources\views/bookings/show.blade.php ENDPATH**/ ?>